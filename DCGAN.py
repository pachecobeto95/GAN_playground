...
os.makedirs("./drive/MyDrive/DCGAN-MNIST/images", exist_ok=True)
...
for epoch in range(opt.n_epochs):
    ...
    for i, (imgs, _) in enumerate(dataloader):
        ...
        print(
            ...
            % (epoch, opt.n_epochs, i, len(dataloader), d_loss.item(), g_loss.item(), total_loss)
        )
    ...
    torch.save({
            ...
            }, "./drive/MyDrive/DCGAN-MNIST/best_model_GAN_2.pth")
